...
/****** Object:  Database [GYMproject]    Script Date: 04-04-2023 11.07.16 AM ******/
CREATE DATABASE [GYMproject]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'GYMproject', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\GYMproject.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'GYMproject_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\GYMproject_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [GYMproject] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [GYMproject] SET  ENABLE_BROKER 
GO
...
ALTER DATABASE [GYMproject] SET  READ_WRITE 
GO
